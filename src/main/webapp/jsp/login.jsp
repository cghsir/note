...
<body class="login">
  <!-- BEGIN LOGO -->
  <div class="logo">
    <img src="${pageContext.request.contextPath}/jsp/assets/img/logo-big.png" alt="" /> 
  </div>
  <!-- END LOGO -->
  <!-- BEGIN LOGIN -->
  <div class="content">
    <!-- BEGIN LOGIN FORM -->
    <!-- 修改login的action -->
    <form class="form-vertical login-form" method="post" action="${pageContext.request.contextPath}/user/doLogin">
    ...
    <form class="form-vertical forget-form" action="user/doLogin">
...
<!-- TODO 登录页面的样式与其他样式不一样 class="copyright" -->
  ...
  <!-- END COPYRIGHT -->
  <!-- BEGIN JAVASCRIPTS -->
  <script src="${pageContext.request.contextPath}/jsp/assets/js/jquery-1.8.3.min.js"></script>
  <script src="${pageContext.request.contextPath}/jsp/assets/bootstrap/js/bootstrap.min.js"></script>  
  <script src="${pageContext.request.contextPath}/jsp/assets/uniform/jquery.uniform.min.js"></script> 
  <script src="${pageContext.request.contextPath}/jsp/assets/js/jquery.blockui.js"></script>
